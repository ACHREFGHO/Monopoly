...
export const BOARD_SPACES: Space[] = [
    ...
    { id: 1, name: 'Kairouan', type: 'property', country: 'Tunisia', color: '#8B4513', price: 60, rent: [2, 10, 30, 90, 160, 250] },
    { id: 2, name: 'Comm. Chest', type: 'chest' },
    { id: 3, name: 'Tunis', type: 'property', country: 'Tunisia', color: '#8B4513', price: 60, rent: [4, 20, 60, 180, 320, 450] },
    { id: 4, name: 'Income Tax', type: 'tax' },
    { id: 5, name: 'Station 1', type: 'station', price: 200, rent: [25, 50, 100, 200] },
    { id: 6, name: 'Oran', type: 'property', country: 'Algeria', color: '#38BDF8', price: 100, rent: [6, 30, 90, 270, 400, 550] },
    { id: 7, name: 'Chance', type: 'chance' },
    { id: 8, name: 'Constantine', type: 'property', country: 'Algeria', color: '#38BDF8', price: 100, rent: [6, 30, 90, 270, 400, 550] },
    { id: 9, name: 'Algiers', type: 'property', country: 'Algeria', color: '#38BDF8', price: 120, rent: [8, 40, 100, 300, 450, 600] },
    { id: 10, name: 'Jail', type: 'jail' },
    { id: 11, name: 'Marrakech', type: 'property', country: 'Morocco', color: '#EC4899', price: 140, rent: [10, 50, 150, 450, 625, 750] },
    { id: 12, name: 'Electric Co.', type: 'utility', price: 150 },
    { id: 13, name: 'Casablanca', type: 'property', country: 'Morocco', color: '#EC4899', price: 140, rent: [10, 50, 150, 450, 625, 750] },
    { id: 14, name: 'Rabat', type: 'property', country: 'Morocco', color: '#EC4899', price: 160, rent: [12, 60, 180, 500, 700, 900] },
    { id: 15, name: 'Station 2', type: 'station', price: 200, rent: [25, 50, 100, 200] },
    { id: 16, name: 'Lyon', type: 'property', country: 'France', color: '#F97316', price: 180, rent: [14, 70, 200, 550, 750, 950] },
    { id: 17, name: 'Comm. Chest', type: 'chest' },
    { id: 18, name: 'Marseille', type: 'property', country: 'France', color: '#F97316', price: 180, rent: [14, 70, 200, 550, 750, 950] },
    { id: 19, name: 'Paris', type: 'property', country: 'France', color: '#F97316', price: 200, rent: [16, 80, 220, 600, 800, 1000] },
    { id: 20, name: 'Free Parking', type: 'parking' },
    { id: 21, name: 'Naples', type: 'property', country: 'Italy', color: '#EF4444', price: 220, rent: [18, 90, 250, 700, 875, 1050] },
    { id: 22, name: 'Chance', type: 'chance' },
    { id: 23, name: 'Milan', type: 'property', country: 'Italy', color: '#EF4444', price: 220, rent: [18, 90, 250, 700, 875, 1050] },
    { id: 24, name: 'Rome', type: 'property', country: 'Italy', color: '#EF4444', price: 240, rent: [20, 100, 300, 750, 925, 1100] },
    { id: 25, name: 'Station 3', type: 'station', price: 200, rent: [25, 50, 100, 200] },
    { id: 26, name: 'Valencia', type: 'property', country: 'Spain', color: '#EAB308', price: 260, rent: [22, 110, 330, 800, 975, 1150] },
    { id: 27, name: 'Barcelona', type: 'property', country: 'Spain', color: '#EAB308', price: 260, rent: [22, 110, 330, 800, 975, 1150] },
    { id: 28, name: 'Water Works', type: 'utility', price: 150 },
    { id: 29, name: 'Madrid', type: 'property', country: 'Spain', color: '#EAB308', price: 280, rent: [24, 120, 360, 850, 1025, 1200] },
    { id: 30, name: 'Go To Jail', type: 'gotojail' },
    { id: 31, name: 'Braga', type: 'property', country: 'Portugal', color: '#22C55E', price: 300, rent: [26, 130, 390, 900, 1100, 1275] },
    { id: 32, name: 'Porto', type: 'property', country: 'Portugal', color: '#22C55E', price: 300, rent: [26, 130, 390, 900, 1100, 1275] },
    { id: 33, name: 'Comm. Chest', type: 'chest' },
    { id: 34, name: 'Lisbon', type: 'property', country: 'Portugal', color: '#22C55E', price: 320, rent: [28, 150, 450, 1000, 1200, 1400] },
    { id: 35, name: 'Station 4', type: 'station', price: 200, rent: [25, 50, 100, 200] },
    { id: 36, name: 'Chance', type: 'chance' },
    { id: 37, name: 'Patras', type: 'property', country: 'Greece', color: '#3B82F6', price: 350, rent: [35, 175, 500, 1100, 1300, 1500] },
    { id: 38, name: 'Travel Tax', type: 'tax', price: 100 },
    { id: 39, name: 'Athens', type: 'property', country: 'Greece', color: '#3B82F6', price: 400, rent: [50, 200, 600, 1400, 1700, 2000] },
];
